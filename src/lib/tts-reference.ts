...
export const REFERENCE_LANGUAGES: TtsLanguage[] = [
  {
    ...
    name: 'English',
    voices: [
      { name: 'Aria (Female)', source: 'edge', edge: 'en-US-AriaNeural' },
      { name: 'Jenny (Female)', source: 'edge', edge: 'en-US-JennyNeural' },
      { name: 'Guy (Male)', source: 'edge', edge: 'en-US-GuyNeural' },
      { name: 'Michelle (Female)', source: 'edge', edge: 'en-US-MichelleNeural' },
      { name: 'Ana (Female)', source: 'edge', edge: 'en-US-AnaNeural' },
    ],
  },
  {
    code: 'zh',
    name: 'Chinese',
    voices: [
      { name: 'Xiaoxiao (Female)', source: 'edge', edge: 'zh-CN-XiaoxiaoNeural', group: 'Mandarin' },
      { name: 'Xiaoyi (Female)', source: 'edge', edge: 'zh-CN-XiaoyiNeural', group: 'Mandarin' },
      { name: 'Yunxi (Male)', source: 'edge', edge: 'zh-CN-YunxiNeural', group: 'Mandarin' },
      { name: 'Yunyang (Male)', source: 'edge', edge: 'zh-CN-YunyangNeural', group: 'Mandarin' },
      { name: 'HiuGaai (Female)', source: 'edge', edge: 'zh-HK-HiuGaaiNeural', group: 'Cantonese' },
      { name: 'WanLung (Male)', source: 'edge', edge: 'zh-HK-WanLungNeural', group: 'Cantonese' },
    ],
  },
  {
    code: 'ja',
    name: 'Japanese',
    voices: [
      { name: 'Nanami (Female)', source: 'edge', edge: 'ja-JP-NanamiNeural' },
      { name: 'Keita (Male)', source: 'edge', edge: 'ja-JP-KeitaNeural' },
    ],
  },
  {
    code: 'ko',
    name: 'Korean',
    voices: [
      { name: 'SunHi (Female)', source: 'edge', edge: 'ko-KR-SunHiNeural' },
      { name: 'InJoon (Male)', source: 'edge', edge: 'ko-KR-InJoonNeural' },
    ],
  },
  {
    code: 'es',
    name: 'Spanish',
    voices: [
      { name: 'Elvira (Female)', source: 'edge', edge: 'es-ES-ElviraNeural' },
      { name: 'Alvaro (Male)', source: 'edge', edge: 'es-ES-AlvaroNeural' },
      { name: 'Dalia (Female)', source: 'edge', edge: 'es-MX-DaliaNeural' },
    ],
  },
  {
    code: 'fr',
    name: 'French',
    voices: [
      { name: 'Denise (Female)', source: 'edge', edge: 'fr-FR-DeniseNeural' },
      { name: 'Henri (Male)', source: 'edge', edge: 'fr-FR-HenriNeural' },
      { name: 'Vivienne (Female)', source: 'edge', edge: 'fr-FR-VivienneNeural' },
    ],
  },
  {
    code: 'ru',
    name: 'Russian',
    voices: [
      { name: 'Svetlana (Female)', source: 'edge', edge: 'ru-RU-SvetlanaNeural' },
      { name: 'Dmitry (Male)', source: 'edge', edge: 'ru-RU-DmitryNeural' },
      { name: 'Dariya (Female)', source: 'edge', edge: 'ru-RU-DariyaNeural' },
    ],
  },
]
