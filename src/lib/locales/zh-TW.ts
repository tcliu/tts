...
export const zhTW: UiText = {
  ...
  adminTitle: '管理',
  adminLoginDescription: '登入以管理應用程式屬性與已快取語音合成。',
  adminNotConfigured: '尚未設定管理員密碼，請在伺服器設定 ADMIN_PASSWORD_HASH（或 ADMIN_PASSWORD）以啟用管理員登入。',
  adminUsername: '使用者名稱',
  adminPassword: '密碼',
  ...
  adminLoginFillBoth: '請輸入使用者名稱與密碼。',
  adminLoginFailed: '登入失敗。',
  adminSections: '管理區段',
