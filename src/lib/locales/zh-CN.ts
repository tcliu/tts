...
export const zhCN: UiText = {
  ...
  adminTitle: '管理',
  adminLoginDescription: '登录以管理应用程序属性与已缓存语音合成。',
  adminNotConfigured: '尚未设置管理员密码，请在服务器设置 ADMIN_PASSWORD_HASH（或 ADMIN_PASSWORD）以启用管理员登录。',
  adminUsername: '用户名',
  adminPassword: '密码',
